...
public class PacienteController {
	...
	private ModelMapper modelMapper;
	    ...
	    @PostMapping
	    public ResponseEntity<?> guardarPaciente( @Valid @RequestBody PacienteDTO pacienteDto , BindingResult result) throws IllegalOperationException {
	    ...
	    @PutMapping("/{id}")
	    public ResponseEntity<ApiResponse<PacienteDTO>> actualizarPaciente(@PathVariable Long id, @RequestBody PacienteDTO pacienteDto) throws EntityNotFoundException, IllegalOperationException {
	    ...
	    @DeleteMapping("/{id}")
	    public ResponseEntity<?> eliminarPaciente(@PathVariable Long id) throws EntityNotFoundException, IllegalOperationException{
	    ...
	    public ResponseEntity<?> asignarCita (@PathVariable Long IdPaciente, @PathVariable Long IdCita) throws EntityNotFoundException, IllegalOperationException{ 	
